...
function mousePressed(){
 ...
 if(estado === 0){
  ...
  clickbtn(20, 420, 150, 50, 4);
   clickbtn(470, 420, 150, 50, 15);
}
 else if(estado === 4){
  clickbtn(470, 420, 150, 50, 5);
}
else if(estado === 5){
  ...
  clickbtn(470, 420, 150, 50, 11);
}
else if(estado === 11){
 clickbtn(470, 420, 150, 50, 12);
}
 else if(estado === 12){
  clickbtn(470, 420, 150, 50, 13);
}
 else if(estado === 13){
  clickbtn(470, 420, 150, 50, 14);
}
 else if(estado === 14){
  clickbtn(470, 420, 150, 50, 22);
}
else if(estado === 15){
  clickbtn(470, 420, 150, 50, 16);
}
else if(estado === 16){
  ...
  clickbtn( 470, 420, 150, 50, 22);
   ...
   clickbtn(20, 420, 150, 50, 0);
  clickbtn( 470, 420, 150, 50, 23);
}
else if(estado === 23){
  clickbtn( 470, 420, 150, 50, 0);
}
}
